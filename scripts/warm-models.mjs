...
console.log('Downloading generation model (onnx-community/Qwen2.5-1.5B-Instruct)...');
await pipeline('text-generation', 'onnx-community/Qwen2.5-1.5B-Instruct', { dtype: 'q8', progress_callback: logProgress });
